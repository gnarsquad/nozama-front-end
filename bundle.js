...
/***/ function(module, exports, __webpack_require__) {
	...
	var cartActions = __webpack_require__(8);
	var stripeEvents = __webpack_require__(30);

	var displayProduct = function displayProduct(product) {
	  var display = __webpack_require__(31);
	  $('.product-display').empty();
	  $('.product-display').append(display({ product: product }));
	...
	var displayProducts = function displayProducts(products) {
	  ...
	  $('.content').append(display({ products: products }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addToCart = function addToCart(success, failure, id, name, price, qty, img) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + '/cart/',
	    headers: {
	...
	var updateCartItem = function updateCartItem(success, failure, id, qty) {
	  $.ajax({
	    method: 'PATCH',
	    url: app.api + '/cart/',
	    headers: {
	...
	var deleteCartItem = function deleteCartItem(success, failure, id) {
	  $.ajax({
	    url: app.api + '/cart/',
	    method: "DELETE",
	    headers: {
	...
	var emptyCart = function emptyCart(success, failure) {
	  $.ajax({
	...
	var getOrders = function getOrders(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/orders/',
	    dataType: 'json',
	...
	var createOrder = function createOrder(success, failure, data) {
	  $.ajax({
	    method: "POST",
	    url: app.api + '/orders',
	    dataType: 'json',
	...
	var getCartOrder = function getCartOrder(success, failure) {
	  $.ajax({
	    url: app.api + "/cart",
	    method: 'GET',
	    dataType: 'json',
	...
	var stripeCharge = function stripeCharge(success, failure, credentials) {
	  $.ajax({
	    url: app.api + '/charge',
	    method: "POST",
	    headers: {
...
/***/ function(module, exports) {
	...
	var app = {
	  ...
	  api: 'https://nozama-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var orderSuccess = function orderSuccess(data) {
	  var orders = data.order;
	  console.log(orders);
	  var display = __webpack_require__(29);
	...
	var stripeSuccess = function stripeSuccess(data) {
	  console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var itemTotal = function itemTotal() {
	...
	var displayCart = function displayCart(cart) {
	  ...
	  $('.change-qty').on('click', function () {
	    var newQty = $(this).parent().find('.new-qty').val();
	    var id = $(this).data('id');
	...
	var getCartDisplay = function getCartDisplay() {
	  $.ajax({
	    url: app.api + "/cart",
	    method: 'GET',
	    dataType: 'json',
	...
	var checkCart = function checkCart(cart, product) {
	  var inCart = 0;
	  ...
	  $('#cart-add').on('click', function () {
	    ...
	    var qty = parseInt($('#quantity-select').val()) + inCart;
	    if (inCart === 0) {
	...
	var getCartCheck = function getCartCheck(product) {
	  $.ajax({
	    url: app.api + "/cart",
	    method: 'GET',
	    dataType: 'json',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"well well-sm line-item\" data-id="
	    ...
	    + "</h4>\n      </div>\n    </div>\n    <hr style=\"margin-top: 5px; margin-bottom: 5px;\">\n    <div class=\"row\">\n      <div class=\"col-md-8\">\n          <h4 class=:\"text-right\">Quantity: <span class=\"label label-primary qty-display\">"
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + "</span>\n            <input class=\"new-qty\" type=\"text\" value="
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + " pattern=\"[0-9]{1,2}\" style=\"width: 30px\">\n            <button type=\"button\" class=\"btn btn-default change-qty\" data-id="
	    + alias4(((helper = (helper = helpers.productid || (depth0 != null ? depth0.productid : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"productid","hash":{},"data":data}) : helper)))
	    + ">\n              <span class=\"glyphicon glyphicon-refresh\" aria-hidden=\"true\"></span> Change\n            </button>\n            <button type=\"button\" class=\"btn btn-default delete-item\" data-id="
	    + alias4(((helper = (helper = helpers.productid || (depth0 != null ? depth0.productid : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"productid","hash":{},"data":data}) : helper)))
	    + ">\n              <span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span> Delete\n            </button>\n          </h4>\n      </div>\n      <div class=\"col-md-4\">\n        <h5 class=\"text-right\">Item subtotal: $<span class=\"item-total\" data-price="
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + " data-qty="
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + "></span></h5>\n      </div>\n    </div>\n  </div>\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cart : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"well well-sm order\">\n  <h4>Order purchased: <span>"
	    + container.escapeExpression(((helper = (helper = helpers.createdAt || (depth0 != null ? depth0.createdAt : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"createdAt","hash":{},"data":data}) : helper)))
	    + "</span></h4>\n"
	  ...
	  return "    <div class=\"well well-sm line-item\" data-id="
	    ...
	    + "</h4>\n        </div>\n      </div>\n      <hr style=\"margin-top: 5px; margin-bottom: 5px;\">\n      <div class=\"row\">\n        <div class=\"col-md-8\">\n            <h4 class=:\"text-right\">Quantity: <span class=\"label label-primary qty-display\">"
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + "</span></h4>\n        </div>\n        <div class=\"col-md-4\">\n          <h5 class=\"text-right\">Item subtotal: $<span class=\"order-item-total\" data-price="
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + " data-qty="
	    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
	    + "></span></h5>\n        </div>\n      </div>\n    </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"row\">\n  <div class=\"col-md-7\">\n    <div class=\"img-main\">\n      <img src="
	    ...
	    + " class=\"img-responsive text-center\" data-id="
	    ...
	    + "</h4>\n      <h5>Quantity:</h5>\n      <select name=\"quantity\" class=\"quantity\" id=\"quantity-select\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1._id : stack1), depth0))
	    ...
	    + "</p>\n      <hr>\n      <button id=\"cart-add\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.product : depth0)) != null ? stack1._id : stack1), depth0))
	    + " type=\"button\" class=\"btn btn-success loggedout-hide\" style=\"width: 100%;\">Add to cart</button>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <li class=\"product-tile\" data-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">\n      <img src="
	    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
	    + " class=\"img-responsive gallery-product\" data-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + " name="
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + " />\n      <h4 data-id="
	    ...
	    + ">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h4>\n      <h5 style=\"float: right\" class=\"price\">$"
	    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
	    + "</h5>\n    </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
